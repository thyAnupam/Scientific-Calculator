# -*- coding: utf-8 -*-
"""
Created on Thu Dec  5 22:42:14 2019l
...
btnSq = Button(calc, text="^0.5", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="yellow",command= added_value.squared).grid(row=1, column=2, pady=1)
...
btnSub = Button(calc, text="-", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="green",command = lambda: added_value.operation("sub")).grid(row=2, column=3, pady=1)
...
btnDiv = Button(calc, text="/", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="green",command = lambda: added_value.operation(divide)).grid(row=4, column=3, pady=1)
...
btnDot = Button(calc, text=".", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="powder blue",command = lambda: added_value.numberEnter(".")).grid(row=5, column=0, pady=1)
btnZero = Button(calc, text="0", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="red",command = lambda: added_value.numberEnter(0)).grid(row=5, column=1, pady=1)
...
btnPi = Button(calc, text="pi", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="powder blue", command=added_value.pi).grid(row=1, column=7, pady=1)

btnSin = Button(calc, text="sin", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="powder blue",command=added_value.sin).grid(row=1, column=4, pady=1)
...
btnSinh = Button(calc, text="sinh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="powder blue",command=added_value.sinh).grid(row=2, column=4, pady=1)
...
btnLog = Button(calc, text="log", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="powder blue",command=added_value.log).grid(row=2, column=7, pady=1)
...
btnLog10 = Button(calc, text="log10", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="powder blue",command=added_value.log10).grid(row=3, column=7, pady=1)

btnExp = Button(calc, text="exp", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="powder blue",command=added_value.exp).grid(row=3, column=4, pady=1)
...
btnE = Button(calc, text="e", width=6, height=2, font=('arial', 20, 'bold'), bd=4, 
                  bg="powder blue",command=added_value.e).grid(row=3, column=6, pady=1)
...
def iExit():
    iExit = tkinter.messagebox.askyesno("Scientific Calculator", "Confirm")
    if iExit > 0:
        root.destroy()
        return
def Scientific():
...
editfilemenu = Menu(menubar, tearoff =0)
menubar.add_cascade(label = "Edit", menu=filemenu)
editfilemenu.add_command(label = "Cut")
editfilemenu.add_command(label = "Copy")
editfilemenu.add_separator()
editfilemenu.add_command(label = "Paste")
